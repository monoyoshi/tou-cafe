let recipes = {
        ...
        "instructions": [
            {
                ...
                "list": [
                    ...
                    {
                        "base": "mix in 1/2 teaspoon baking soda and 1/16 teaspoon salt",
                        "notes": []
                    },
                    {
        ...
        "instructions": [
            {
                ...
                "list": [
                    ...
                    {
                        "base": "lightly coat pan with butter",
                        "notes": []
                    },
                    {
                        "base": "for each crêpe:",
            ...
            },
            {
                ...
                "list": [
                    ...
                    {
                        "base": "beat in 2 tsp vanilla extract until well incorporated and smooth",
                        "notes": []
                    }
                ]
            },
            {
                ...
                "list": [
                    {
                        "base": "spread ~1 1/2 tablespoon frosting on the base of a serving plate",
                        "notes": []
                    },
                    {
                        "base": "place first crêpe on top",
                        "notes": []
                    },
                    {
                        "base": "for each crêpe or until the desired height is reached:",
                        "notes": [
                    ...
                    {
                        "base": "spread ~1 1/2 tablespoon frosting on top of the topmost crêpe",
                        "notes": []
                    },
                    {
                        "base": "refrigerate cake for ~6 hours or until frosting has solidified",
                        "notes": []
                    },
                    {
        ...
        "instructions": [
            ...
            },
            {
                ...
                "list": [
                    ...
                    {
                        "base": "fill the insides of each muffin with the filling by gently squeezing for ~1 second",
                        "notes": []
                    },
                    {
                        "base": "evenly top each muffin with the leftover filling",
                        "notes": []
                    },
                    {
                        "base": "bake for ~18 minutes or until a toothpick stabbed into the middle comes out mostly clean",
                        "notes": []
                    },
                    {
                        "base": "let muffins cool in the tin for 10+ minutes",
                        "notes": []
                    },
                    {
                        "base": "transfer to wire rack to cool completely",
                        "notes": []
                    },
                    {
    ...
    "red-velvet-cookies": {
        ...
        "equipment": [
            {
                "name": "stand mixer with a flat beater attachment",
                "notes": []
            },
            {
                "name": "cookie scoop",
        ...
        "instructions": [
            {
                ...
                "list": [
                    ...
                    {
                        "base": "beat in 1 cup white chocolate chips until mixture is thick and sticky",
                        "notes": []
                    }
                ]
            },
            {
                ...
                "list": [
                    ...
                    {
                        "base": "line 2 baking sheets with parchment paper",
                        "notes": []
                    },
                    {
                        "base": "form the cookie dough into loosely packed balls about 1 1/4 tbsp in size and place 2 inches apart on the baking sheets",
                        "notes": [
                            "use a cookie scoop to help",
                            "be able to place cookies in at least a 5x3 grid"
                        ]
                    },
                    {
    ...
    "sachertorte": {
        ...
        "equipment": [
            {
                "name": "cake pan",
                "notes": ["the size determines how tall the cake will be (recommended: 9x3 inches)"]
            },
            {
                "name": "parchment paper",
                "notes": []
